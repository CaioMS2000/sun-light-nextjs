    ...
    <>
      ...
      <div className="mt-10 flex w-full justify-start pl-2 md:mt-28 md:justify-end">
        <p className="max-w-80 text-xs md:max-w-3xl md:text-base">
          ...
          inabalável com a inovação, oferecemos soluções personalizadas para
          projetos de todos os tamanhos. Nossa equipe dedicada trabalha
          incansavelmente para entregar os melhores sistemas de energia solar,
          garantindo máxima eficiência e economia para nossos clientes. Estamos
          comprometidos em moldar um futuro energético mais sustentável através
          da energia solar.{' '}
        </p>
      </div>
      <div className="mt-40 flex items-center justify-around bg-light-grey md:mt-60 md:px-5">
        ...
        <Card className="h-fit border-none bg-transparent shadow-transparent">
          ...
          <CardContent>
            <p className="text-sm">
              Nossa extensa experiência e profunda expertise no setor de energia
              solar nos posicionaram como referência no mercado. Com anos de
              atuação especializada, aperfeiçoamos nosso conhecimento em
              sistemas fotovoltaicos e eficiência energética solar a um nível
              que nos diferencia. O profundo entendimento de nossa equipe neste
              segmento nos permite fornecer soluções inovadoras e personalizadas
              que não apenas atendem, mas superam as expectativas de nossos
              clientes na implementação de energia solar.{' '}
            </p>
          </CardContent>
