				...
				<div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-around">
					<div className="flex flex-col gap-3 md:gap-16">
						...
						<div className="">
							...
							<p className="text-sm">
								Finais de semana: <span className="text-black/40 italic">fechado</span>
							</p>
						</div>
					</div>
						...
						>
											...
											<Label>
												...
												>
													<div className="flex items-center space-x-2">
														...
														/>
														<Label htmlFor="yes" className="text-accent-100/50 text-xs">
															Sim
														</Label>
													</div>
													<div className="flex items-center space-x-2">
														<RadioGroupItem
															...
															className="border-input text-zinc-500"
														/>
														<Label htmlFor="no" className="text-accent-100/50 text-xs">
															Não
														</Label>
													</div>
												</RadioGroup>
							...
							<fieldset>
								<Label className="text-zinc-500">
									Mensagem <Textarea {...register('message')} className="mt-3" />
								</Label>
							</fieldset>
							<Button
								type="submit"
