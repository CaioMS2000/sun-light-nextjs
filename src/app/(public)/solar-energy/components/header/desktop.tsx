...
export default function DesktopHeader() {
	return (
		<>
			<header className='relative hidden h-[400px] w-screen bg-[url("/images/banners/IMG-20241202-WA0030.jpg")] bg-coverr bg-[position:40%_50%] md:flex'>
				<NavHeader className="absolute w-screen bg-black/60 text-white" />
				<div className="flex h-full items-end bg-accentt-100/80 pr-3 text-white">
					<div className="space-y-10 p-5 pl-14 bg-accent-100">
